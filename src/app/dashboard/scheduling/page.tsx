...
const AdvancedSchedulingDashboard: React.FC = () => {
  ...
  }, [refreshWorkOrders, refreshTasks]);
  ...
  const handleOptimizationStart = async (config: any) => {
    try {
      await optimizeSchedule(workOrders, config);
    } catch (error) {
    ...
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper sx={{ width: '100%' }}>
        ...
        <TabPanel value={currentTab} index={1}>
          <Box>
            <Typography variant="h5" gutterBottom>Work Orders Management</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
              <Typography variant="body1">Manage and create work orders</Typography>
              <Button
                variant="contained"
        ...
        <TabPanel value={currentTab} index={3}>
          <Box>
            <Typography variant="h5" gutterBottom>Schedule Optimization</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
              <Typography variant="body1">Optimize resource scheduling and routing</Typography>
              <Button
                variant="contained"
      ...
      <OptimizationPanel
        ...
        onStartOptimization={handleOptimizationStart}
